                                                    ...
                                                    <form method="POST" action="addReview.php">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12" style="width: 750px;">
                                                                ...
                                                                <textarea type="text" id="testo" name="testo" class="form-control" required 
                                                                style="font-family: Nunito, sans-serif; font-size: 14px; background-color: rgb(28, 28, 44); color: rgb(171, 183, 196); font-weight: 300; text-transform: none; border: 1px solid rgb(64, 82, 102); border-radius: 3px; height: 94px; margin: 0px 240px 10px 0px; width: 500px;">                                                     
                                                                </textarea>
                                                            </div>
                                                        </div>
